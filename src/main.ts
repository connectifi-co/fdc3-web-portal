...
const intentResolver = (message: IntentResolutionMessage, resolveCallback : ResolveCallback ) => {
  ...
  const context = message.context;
    ...
    message.data.forEach((result) => {
        ...
        result.apps.forEach( app => {
            ...
            appItem.textContent = app.details.directoryData.title || app.details.directoryData.name;
